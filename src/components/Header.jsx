...
const Header = () => {
    ...
    return (
        <Wrapper>
            <FirstRow>
                <LeftHeader src={logo} alt="logo" onClick={handleLogoClick}>
            ...
            <SecondRow>
                <Navigation>
                    <Nav onClick={handleNavClick('/search')}>물품 대여</Nav>
                    <Nav>물품 등록</Nav>
                    <Nav>건강 AtoZ</Nav>
                    <Nav onClick={handleNavClick('/nearby')}>어디GO</Nav>
                    <Nav onClick={handleNavClick('/chatting')}>채팅</Nav>
                </Navigation>
                <Search>
                    <div>
