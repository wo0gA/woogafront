			...
			{roomData && (
				<section class="flex flex-col flex-1 max-h-[calc(100vh-15rem)]">
					...
					<form class="flex items-center border" onSubmit={handleMessageSubmit}>
						...
						/>
						<button
							class={(newMessage === "" ? "opacity-20" : "bg-[#FCFF5D]") + " rounded-xl inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-8 px-4 py-2 ml-4 mr-2"}
							type="submit"
						>
							전송
						</button>
