            ...
            <Contents>
                <Category>
                    ...
                    <CategoryContents>
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("생활체육")}  xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 50 50" fill="none">
                        ...
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("피트니스")} xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 51 50" fill="none">
                        ...
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("구기+스포츠")} xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 51 50" fill="none">
                        ...
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("전문+스포츠")} xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 51 50" fill="none">
                        ...
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("아웃도어")} xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 51 50" fill="none">
                        ...
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("레저 스포츠")} xmlns="http://www.w3.org/2000/svg" width="51" height="50" viewBox="0 0 51 50" fill="none">
                        ...
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("건강 및 웰빙")} xmlns="http://www.w3.org/2000/svg" width="51" height="50" viewBox="0 0 51 50" fill="none">
                        ...
                        <Sports>
                            <Eclipse>
                                <svg onClick={handleCategoryClick("기타")} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
