	...
	return (
		<Wrapper>
			<Banner>
				...
				>
					<path
						d="M29.6167 9.425L26.6667 5L10 30L26.6667 55L29.6167 50.575L15.9 30L29.6167 9.425Z"
						fill="black"
					/>
				</svg>
				<svg
				...
				>
					<path
						d="M10.3828 50.575L13.3328 55L29.9995 30L13.3328 5L10.3828 9.425L24.0995 30L10.3828 50.575Z"
						fill="black"
					/>
				</svg>
			</Banner>
			...
			<Contents>
				<Category>
					...
					<CategoryContents>
						...
						<Sports>
							<Eclipse onClick={handleCategoryClick(1)}>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="51"
									height="50"
						...
						<Sports>
							<Eclipse onClick={handleCategoryClick(1)}>
								...
								>
									<path
										d="M17.5234 17.7083C17.5234 17.125 17.9818 16.6667 18.5651 16.6667H23.8151L23.7734 14.5833H18.5651C17.9818 14.5833 17.5234 14.125 17.5234 13.5417C17.5234 12.9583 17.9818 12.5 18.5651 12.5H23.7734V6.25H7.10677V37.5H13.3568V41.6667H5.02344V45.8333H38.3568C44.1068 45.8333 48.7734 41.1667 48.7734 35.4167H44.6068C44.6068 38.875 41.8151 41.6667 38.3568 41.6667H34.1901V37.5H40.4401V31.5C40.4401 27.125 37.2109 24.1458 34.1276 23.4167L28.5026 22.0208C26.6901 21.5625 25.2318 20.3333 24.4401 18.75H18.5651C17.9818 18.75 17.5234 18.2917 17.5234 17.7083ZM30.0234 41.6667H17.5234V37.5H30.0234V41.6667Z"
										fill="black"
									/>
								</svg>
							</Eclipse>
						...
						<Sports>
							<Eclipse>
								...
								>
									<path
										d="M39.7253 19.375V8.33333H33.4753V13.75L25.1419 6.25L4.30859 25H10.5586V41.6667H20.9753V29.1667H29.3086V41.6667H39.7253V25H45.9753L39.7253 19.375ZM20.9753 20.8333C20.9753 18.5417 22.8503 16.6667 25.1419 16.6667C27.4336 16.6667 29.3086 18.5417 29.3086 20.8333H20.9753Z"
										fill="black"
									/>
								</svg>
							</Eclipse>
						...
						<Sports>
							<Eclipse>
								...
								>
									<path
										d="M12.5007 20.8333C10.209 20.8333 8.33398 22.7083 8.33398 24.9999C8.33398 27.2916 10.209 29.1666 12.5007 29.1666C14.7923 29.1666 16.6673 27.2916 16.6673 24.9999C16.6673 22.7083 14.7923 20.8333 12.5007 20.8333ZM37.5007 20.8333C35.209 20.8333 33.334 22.7083 33.334 24.9999C33.334 27.2916 35.209 29.1666 37.5007 29.1666C39.7923 29.1666 41.6673 27.2916 41.6673 24.9999C41.6673 22.7083 39.7923 20.8333 37.5007 20.8333ZM25.0007 20.8333C22.709 20.8333 20.834 22.7083 20.834 24.9999C20.834 27.2916 22.709 29.1666 25.0007 29.1666C27.2923 29.1666 29.1673 27.2916 29.1673 24.9999C29.1673 22.7083 27.2923 20.8333 25.0007 20.8333Z"
										fill="black"
									/>
								</svg>
							</Eclipse>
